...
namespace HISPlayer
{
    public class HISPlayerController : HISPlayerManager
    {
        ...
        private string[] videoSamples = {
            "https://api.hisplayer.com/media/master.m3u8?contentKey=s7PwvPwJ",
            "https://api.hisplayer.com/media/master.m3u8?contentKey=GdCDsEmW",
        };
        ...
        public void OnVolumeChanged(int playerIndex, float value)
        {
            ...
            //if slider is above 0, then make it so mute button is disabled visually
            isMuted[playerIndex] = (value == 0f);
        ...
        public void OnToggleMute(int playerIndex)
        {
            ...
            float volume = isMuted[playerIndex] ? 0.0f : 1.0f;
            SetVolume(playerIndex, volume);

            //sync slider with mute button
            if (HISPlayerUIHelper.volumeSlider != null && playerIndex < HISPlayerUIHelper.volumeSlider.Length)
                HISPlayerUIHelper.volumeSlider[playerIndex].value = volume;
        ...
        protected override void EventEndOfPlaylist(HISPlayerEventInfo eventInfo)
        {
            ...
            HISPlayerUIHelper.ResetValues(playerIndex, !multiStreamProperties[playerIndex].autoPlay);
        ...
        protected override void EventPlaybackSeekEnd(HISPlayerEventInfo eventInfo)
        {
            base.EventPlaybackSeekEnd(eventInfo);
